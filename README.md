...
/* or */
<KeyboardListener onFullscreenChange={handleFullscreenChange} />
```
...
The listeners that are only should not be an issue because they aren't called when initialized are:
